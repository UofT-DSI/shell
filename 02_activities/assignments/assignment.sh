...
cp data/raw/*server.log data/processed/server_users

# 6. Repeat the above step for user logs and event logs
cp data/raw/*server.log data/processed/log_users
cp data/raw/*server.log data/processed/event_users
# 7. For user privacy, remove all files containing IP addresses (files with "ipaddr" in the filename) from ./data/raw and ./data/processed/user_logs
rm data/raw/*ipaddr*
rm data/processed/log_users/*ipaddr*
